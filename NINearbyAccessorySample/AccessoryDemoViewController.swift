...
//        self.directionLabel.text = String(format: "'%@': %0.2f, %0.2f, %0.2f degrees", name, direction[0], direction[1], direction[2])
        if (direction[0] < -0.25) {
            ...
            self.directionLabel.text = String("On your Right")
        } else {
...
//        self.directionLabel.text = String(format: "'%@': %0.2f, %0.2f, %0.2f degrees", name, direction[0], direction[1], direction[2])
        ...
        if #available(iOS 16.0, *) {
            guard let horizontalAngle = accessory.horizontalAngle else {
                return }
            self.horizontalAngleLabel.text = String(format: "'%@': %0.1f degrees", name, horizontalAngle)
            self.horizontalAngleLabel.sizeToFit()
        } else {
